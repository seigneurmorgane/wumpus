...
public class RandomWalkBisBehaviour extends OneShotBehaviour{
	...
	public RandomWalkBisBehaviour (final AbstractDedaleAgent myagent) {
		super(myagent);
	}
	...
	public void action() {
		...
		if (myPosition!=null){
			...
			System.out.println(this.myAgent.getLocalName() + " Move to : "+lobs.get(moveId).getLeft());
