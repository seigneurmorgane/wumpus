...
public class ReceiveInfosBehaviour extends SimpleBehaviour{
	...
	private List<Couple<String,List<Couple<Observation,Integer>>>> otherClosedNodes= new ArrayList<>();
	private List<Couple<String,String>> otherEdges = new ArrayList<>();
	private List<String> openNodes = new ArrayList<String>();
	private List<String> path = new ArrayList<String>();
	private boolean finished = false;
	private int trans = 5;

	public ReceiveInfosBehaviour(final AbstractDedaleAgent myagent, MapRepresentation myMap, List<Couple<String,List<Couple<Observation,Integer>>>> otherClosedNodes, List<Couple<String,String>> otherEdges, List<String> openNodes) {
		super(myagent);
		...
		if (msg != null) {
			...
			try {
				...
				Couple<List<Couple<String,List<Couple<Observation,Integer>>>>,Couple<List<Couple<String,String>>,List<Integer>>> infos = (
						Couple<List<Couple<String,List<Couple<Observation,Integer>>>>,Couple<List<Couple<String,String>>,List<Integer>>>)(msg.getContentObject());
