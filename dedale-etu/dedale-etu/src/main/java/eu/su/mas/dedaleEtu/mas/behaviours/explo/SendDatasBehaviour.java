...
public class SendDatasBehaviour extends OneShotBehaviour{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2462583159952967567L;
	...
	public void action() {
		...
		try {
			...
			if (result == null || result.length <= 0) {
				...
				// les aretes + priorité
				Couple<Integer,Couple<String,List<String>>> tmp2 = new Couple<Integer,Couple<String,List<String>>>(0,prio);
