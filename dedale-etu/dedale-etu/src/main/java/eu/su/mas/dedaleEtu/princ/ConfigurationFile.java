...
public final class ConfigurationFile {
	...
	/**
	 * Required by the environment class to be able to load it. Currently, only one
	 * type of environment is available
	 */
	 ...
	 * 
	 * When the environment is loaded we need : - a topology, - the configuration of
	 * the elements on the map, - and the characteristics of the agents.
	 *
	 * The two first parameters must be null if the environment is generated or
	 * already online
	 * 
	 *****************************/

	/**
	 * Not null when the environment is loaded; should be null if the environment is
	 * generated or already online
	 */
...
//	public static String INSTANCE_TOPOLOGY = "resources/mapInterlocking3-topology";
//	public static String INSTANCE_TOPOLOGY="resources/mapInterlocking3-topology";
...
//	public static String INSTANCE_CONFIGURATION_ELEMENTS="resources/map2018-elements";
	public static String INSTANCE_CONFIGURATION_ELEMENTS="resources/map2018-elements2";
